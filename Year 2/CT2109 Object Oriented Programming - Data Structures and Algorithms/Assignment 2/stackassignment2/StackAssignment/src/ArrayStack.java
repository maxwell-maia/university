...
public class ArrayStack implements Stack
{
    ...
    {
        //loop through the array containing the stack
        for(int i = 0; i < top; i++)
        {
            if((char)S[i] == c)
            {
                //If the character is found somewhere in the stack, return true
                return true;
            }
        }
        //otherwise, the character was not found, returns false.
        return false;
    }
}